...
describe('Unit | Use Case | notify-new-grades', () => {
  ...
  context('when there are differences between oldGrades and newGrades', () => {
    ...
    it('should save grades in file', async () => {
      ...
      const newGrades = [{ module: 'Module de test', matieres: [{ title: 'Test', evaluations:[{ title: 'CC', note: '13', noteRattrapage: '' }] }] }];
      ...
      // then
      expect(writeFileStub).to.have.been.calledWithExactly('test.json', JSON.stringify(newGrades));
    });
  });
